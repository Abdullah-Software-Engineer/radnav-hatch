        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-xl shadow-gray-200/60 sm:rounded-3xl">
          <div className="grid min-h-0 grid-cols-1 lg:grid-cols-2 lg:min-h-[520px]">
            ...
            <div className="flex flex-col justify-center bg-[#F8F8F8] px-6 py-10 sm:px-10 sm:py-14 md:px-12 md:py-16 lg:px-14 lg:py-20">
              <h1 className="text-2xl font-bold leading-[1.2] tracking-tight text-[#2F333E] sm:text-3xl md:text-4xl lg:text-[2.25rem] xl:text-5xl xl:leading-[1.15]">
                Building stronger radiology teams through{" "}
                <span className="text-[#2563EB]">trusted staffing solutions.</span>
              </h1>
              <p className="mt-5 max-w-xl text-base leading-relaxed text-[#6B7280] sm:mt-6 sm:text-lg">
              ...
              <p className="mt-3 max-w-xl text-base leading-relaxed text-[#6B7280] sm:mt-4 sm:text-lg">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3 sm:mt-10 sm:gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-xl bg-[#1F5C86] px-5 py-3.5 text-base font-medium text-white shadow transition hover:bg-[#1a4d6f] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1F5C86] focus-visible:ring-offset-2 sm:px-6 sm:py-4"
                >
                  Connect With Us
                </Link>
                <Link
                  href="/services"
                  className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-[#D1D5DB] bg-transparent px-5 py-3.5 text-base font-medium text-[#4B5563] transition hover:border-[#9CA3AF] hover:bg-[#F9FAFB] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 sm:px-6 sm:py-4"
                >
                  Our Services
                  <svg
            ...
            <div className="relative min-h-[300px] bg-[#F1F5F9] sm:min-h-[360px] lg:min-h-0">
              ...
              >
                ...
                <span className="text-sm font-medium text-[#4B5563] sm:text-base">
